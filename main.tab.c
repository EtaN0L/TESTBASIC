...
{
       0,   147,   147,   151,   152,   153,   154,   158,   159,   163,
     164,   165,   166,   167,   168
};
#endif
...
static const char *const yytname[] =
{
  ...
  "START", "END", "DEF", "IF", "ELSE", "WHILE", "FOR", "PRINT", "SCAN",
  "CMP", "'='", "'+'", "'-'", "'*'", "'/'", "$accept", "program", "stmt",
...
{
      18,   -11,   -10,     7,    13,   -11,    18,    17,     7,   -11,
      -2,   -11,   -11,     7,     7,     7,     7,    17,     0,     9,
       9,   -11,   -11,    18,    18
};
...
{
       0,     9,    10,     0,     0,     7,     2,     4,     0,    10,
       0,     1,     8,     0,     0,     0,     0,     3,     6,    11,
      12,    13,    14,     0,     5
};
...
{
      12,     1,     2,     1,     2,     8,     3,    18,     3,    23,
       1,     9,    12,    11,    13,    14,    15,    16,    12,    10,
      24,     1,     2,     0,    17,     0,     3,    15,    16,    19,
      20,    21,    22,    13,    14,    15,    16
};

static const yytype_int8 yycheck[] =
{
       6,     3,     4,     3,     4,    15,     8,    10,     8,     9,
       3,     4,    18,     0,    16,    17,    18,    19,    24,     3,
      23,     3,     4,    -1,     8,    -1,     8,    18,    19,    13,
...
{
       0,     3,     4,     8,    21,    22,    23,    24,    15,     4,
      24,     0,    22,    16,    17,    18,    19,    24,    23,    24,
      24,    24,    24,     9,    23
};
...
#line 147 "main.y"
                { (yyval.ast) = (yyvsp[0].next); }
#line 1208 "main.tab.c"
    break;

  case 3: /* stmt: STRING '=' expr  */
#line 151 "main.y"
                                     { (yyval.ast) = new_assign((yyvsp[-2].str), (yyvsp[0].ast)); }
...
#line 1220 "main.tab.c"
  ...
  case 5: /* stmt: IF expr stmt_list ELSE stmt_list  */
#line 153 "main.y"
                                       { (yyval.ast) = new_if((yyvsp[-3].ast), (yyvsp[-2].next), (yyvsp[0].next)); }
#line 1226 "main.tab.c"
    break;

  case 6: /* stmt: IF expr stmt_list  */
#line 154 "main.y"
                                       { (yyval.ast) = new_if((yyvsp[-1].ast), (yyvsp[0].next), NULL); }
#line 1232 "main.tab.c"
    break;

  case 7: /* stmt_list: stmt  */
#line 158 "main.y"
                                  { (yyval.next) = new_stmt_list((yyvsp[0].ast), NULL); }
#line 1238 "main.tab.c"
    break;

  case 8: /* stmt_list: stmt_list stmt  */
#line 159 "main.y"
                                  { (yyval.next) = new_stmt_list((yyvsp[0].ast), (yyvsp[-1].next)); }
#line 1244 "main.tab.c"
    break;

  case 9: /* expr: NUM  */
#line 163 "main.y"
                         { (yyval.ast) = new_num((yyvsp[0].num)); }
#line 1250 "main.tab.c"
    break;

  case 10: /* expr: STRING  */
#line 164 "main.y"
                         { (yyval.ast) = new_var((yyvsp[0].str)); }
#line 1256 "main.tab.c"
    break;

  case 11: /* expr: expr '+' expr  */
#line 165 "main.y"
                         { (yyval.ast) = new_binop('+', (yyvsp[-2].ast), (yyvsp[0].ast)); }
